...
class RegisterPostUseCase @Inject constructor(
    ...
    operator fun invoke(postId: Long, imageList: List<String>, authorName: String, name: String,  tags: List<String>)=
        if (authorName.isEmpty() || name.isEmpty() || tags.isEmpty()) {
            cameraRepository.registerOnlyImages(postId, imageList)
